...
lv_obj_t *zmk_display_status_screen()
{
    ...
    lv_obj_align(zmk_widget_output_status_obj(&output_status_widget), LV_ALIGN_BOTTOM_MID, 88, -2);
#endif
    ...
    zmk_widget_layer_status_init(&layer_status_widget, screen);
        lv_obj_align(zmk_widget_layer_status_obj(&layer_status_widget), LV_ALIGN_BOTTOM_MID, 0, -24);
#endif
    ...
    lv_obj_align(zmk_widget_eyes_status_obj(&eyes_status_widget), LV_ALIGN_CENTER, 8, -10);
#endif

#if CONFIG_DONGLE_SCREEN_MODIFIER_ACTIVE
    zmk_widget_mod_status_init(&mod_widget, screen);
        lv_obj_align(zmk_widget_mod_status_obj(&mod_widget), LV_ALIGN_BOTTOM_MID, 0, -48);
#endif
